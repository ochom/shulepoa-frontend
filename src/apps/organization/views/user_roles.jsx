            ...
            {selected_group && this.props.rights.can_edit_user_role ?
              <>
                ...
                <div className="list-group">
                  ...
                  <div className="list-group-item"> <span> Can edit organization</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_edit_organization} onChange={() => this.onCheckChange('can_edit_organization')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can add department</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_add_department} onChange={() => this.onCheckChange('can_add_department')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can edit department</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_edit_department} onChange={() => this.onCheckChange('can_edit_department')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can add academic stage</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_add_class} onChange={() => this.onCheckChange('can_add_class')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can edit academic stage</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_edit_class} onChange={() => this.onCheckChange('can_edit_class')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can add classroom</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_add_classroom} onChange={() => this.onCheckChange('can_add_classroom')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can edit classroom</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_edit_classroom} onChange={() => this.onCheckChange('can_edit_classroom')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can edit subject</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_edit_subject} onChange={() => this.onCheckChange('can_edit_subject')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can add subject</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_add_subject} onChange={() => this.onCheckChange('can_add_subject')} /><span className="slider round"></span> </div></span></div>
                ...
                <div className="list-group">
                  ...
                  <div className="list-group-item"> <span> Can add classroom request</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_add_service_request} onChange={() => this.onCheckChange('can_add_service_request')} /><span className="slider round"></span> </div></span></div>
                  <div className="list-group-item"> <span> Can delete classroom request</span> <span><div className="switch"><input type="checkbox" checked={selected_group.can_delete_service_request} onChange={() => this.onCheckChange('can_delete_service_request')} /><span className="slider round"></span> </div></span></div>
                </div>
              </> :
              null}
          </div>
