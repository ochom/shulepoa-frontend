...
export class Discharge extends Component {
  ...
  componentDidMount() {
    this.setState({ discharge_note: this.props.admission.discharge_note })
  }
  ...
  onSubmit = (e) => {
    ...
    this.props.updateAdmission(this.props.admission.id, data);
  }

  render() {
    const { admission, rights } = this.props
    return (
      <>
          ...
          <div className="card-body p-0 mt-0">
            <form onSubmit={this.onSubmit}>
              <div className="form-row col-12 mx-auto my-3">
                ...
                <div className="form-group col-12">
                  {rights.can_discharge && !admission.is_discharged ?
