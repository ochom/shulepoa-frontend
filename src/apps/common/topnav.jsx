          ...
          <div className="col-sm-8 col-md-6 col-lg-4"
            ...
            <div className="card card-body py-4 px-2">
              <div className="row col-12 mx-auto">
                ...
                <Link className="main-menu-menu text-center" to="/records"><i className="fa fa-users"></i><br />Records</Link>
                ...
                <Link className="main-menu-menu text-center" to="/revenue"><i className="fa fa-dollar"></i><br />Billing</Link>
