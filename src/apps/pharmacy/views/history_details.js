          ...
          <div className="col-12 mx-auto mt-3">
            <div className="card card-header bg-white py-1 px-3">
              <div className="py-1 px-2">
                ...
                <i className="fa fa-angle-right"></i> &nbsp;
                <Link to="/pharmacy/drugs-reorders">Reorder History</Link> &nbsp;
                <i className="fa fa-angle-right"></i> &nbsp;
                <Link to={`/pharmacy/drugs-reorders/${this.props.match.params.pk}/history`}>
                  {service_list.filter(service => service.id === reorder.service)[0].name}</Link>
              </div>
            </div>
              ...
              <div className="col-3">
                <div className="patient_profile p-0 border border-light rounded ">
                  <div className="row col-12 mx-auto justify-content-center"
                    ...
                    <p className="custom-text-primary col-12 text-center text-white mt-2">Supplier Profile</p>
                  </div>
